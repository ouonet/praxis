 ...
 *
 * Injects praxis bootstrap context via message transform.
...
// Cache bootstrap content — SKILL.md does not change during a session.
...
${toolMapping}
  ...
  return {
    // Register praxis skills directory so OpenCode discovers all skills
