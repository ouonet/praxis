...
RED (fail for the *right reason*) -> GREEN (minimum to pass) -> refactor -> commit -> **edit `docs/staging/plans/YYYY-MM-DD-<topic>.md` and change this task's `- [ ]` to `- [x]`. Do not start the next task without this edit.**
